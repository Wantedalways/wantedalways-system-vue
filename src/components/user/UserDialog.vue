<template>
  ...
  >
    <div class="user-role-container">
      ...
      <div class="pagination-wrapper">
        <el-pagination
          ...
          @update:current-page="queryUserListWithRole"
          v-model:page-size="userQueryParams.pageSize"
          @update:page-size="queryUserListWithRole"
        />
      </div>
    </div>
    ...
    <user-select-dialog
      ...
      v-model:result-users="resultUsers"
      :title="'添加关联用户'"
    />
  </el-dialog>
</template>
