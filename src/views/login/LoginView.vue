<template>
  <el-container class="container">
    <el-main class="main">
      <el-image
        :src="getAssets('image/login-background.svg')"
        class="login-image"
      />
      <div class="form">
        ...
        <div class="form-main">
          <el-tabs stretch class="form-tab">
            <el-tab-pane label="密码登录">
              <account-login />
            </el-tab-pane>
            <el-tab-pane label="扫码登录" disabled> </el-tab-pane>
          </el-tabs>
        </div>
      </div>
    </el-main>
    <el-footer class="footer">
      <el-link type="info" target="_blank" :underline="false" class="link"
        >Copyright &copy; 2025 Wantedalways</el-link
      >
    </el-footer>
  </el-container>
</template>
